...
const bread = [
    ...
    {href: "/index/tactics/user", title: "球员", icon: "user"},
];

class TacticsUser extends React.Component {
                ...
                <div className="content-bg">
                    <Table
                        ...
                        title={() => (
                            <Row gutter={8}>
                                <Col md={8}>一线队员</Col>
                                <Col md={8}>总共{this.state.count}位一线球员</Col>
                                <Col md={8}><Button type="primary"
                                                     onClick={() => this.createPlayer()}>创建一线球员</Button></Col>
                            </Row>
                        )}
                    />
                </div>
