...
const bread=[
    ...
    {href:"/index/cantera/youth",title:"青年队",icon:"team"},
];

class CanteraYouth extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            columns: [
                        ...
                        <Dropdown overlay={
                            <Menu>
                                ...
                                <Menu.SubMenu title="调整">
                                    <Menu.Item key="2" onClick={() => this.setTypes(record,0)}>一线队</Menu.Item>
                                    <Menu.Item key="3" onClick={() => this.setTypes(record,1)}>梯队</Menu.Item>
                                </Menu.SubMenu>
                            </Menu>
                        } trigger={['click']}>
                            <Button>操作</Button>
    ...
    createPlayer = () => {
        ...
        reqCreate_Player({number: 11, types: 2})
            .then(
                res => {
                ...
                <div className="content-bg">
                    <Table
                        ...
                        title={() => (
                            <Row gutter={8}>
                                <Col md={8}>青年队员</Col>
                                <Col md={8}>总共{this.state.count}位青年球员</Col>
                                <Col md={8}><Button type="primary"
                                                    onClick={() => this.createPlayer()}>创建青年球员</Button></Col>
                            </Row>
                        )}
                    />
                </div>
