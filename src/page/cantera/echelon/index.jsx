...
const bread=[
    ...
    {href:"/index/cantera/echelon",title:"梯队",icon:"user"},
];

class CanteraEchelon extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            columns: [
    ...
    createPlayer = () => {
        ...
        reqCreate_Player({number: 11, types: 1})
            .then(
                res => {
                ...
                <div className="content-bg">
                    <Table
                        ...
                        title={() => (
                            <Row gutter={8}>
                                <Col md={8}>梯队队员</Col>
                                <Col md={8}>总共{this.state.count}位梯队球员</Col>
                                <Col md={8}><Button type="primary"
                                                    onClick={() => this.createPlayer()}>创建梯队球员</Button></Col>
                            </Row>
                        )}
                    />
                </div>
